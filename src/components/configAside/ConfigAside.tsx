...
import "./configAside.scss";

function ConfigAside(): ReactNode {
    return (
        <div className="config">
            <button className="config__item item-user">
                <svg
            ...
            <button className="config__item item-filter">
                <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="30"
                    height="30"
            ...
            <button className="config__item item-download">
                <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="30"
                    height="30"
            ...
            <button className="config__item item-settings">
                <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="30"
                    height="30"
